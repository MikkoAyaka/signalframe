    ...
    <SignalPanel interactive={false} tone="quiet" className="overflow-visible">
      <div className="grid min-h-72 min-w-0 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="flex min-w-0 flex-col justify-between">
          <div className="p-6">
            <p className="mb-2 font-mono text-[10px] uppercase tracking-[0.22em] text-red-400">{t("Component")}</p>
          ...
          <div className="mx-auto max-w-5xl space-y-24">
            ...
            <DocSection id="foundations">
              ...
              <div className="grid gap-4 lg:grid-cols-[1.25fr_0.75fr]">
                <SignalPanel interactive={false} tone="quiet" className="p-6">
                  <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-neutral-500">{t("Signal scale")}</p>
                ...
                <SignalPanel interactive={false} tone="quiet" className="p-6">
                  <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-neutral-500">{t("Spacing rhythm")}</p>
            ...
            <DocSection id="typography">
              ...
              <div className="grid gap-4 xl:grid-cols-[0.9fr_1.1fr]">
                <SignalPanel interactive={false} tone="quiet" className="p-6">
                  <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-red-400">{t("Type roles")}</p>
            ...
            <DocSection id="motion">
              ...
              <SignalPanel interactive={false} tone="quiet" className="p-6">
                <div className="grid gap-6 md:grid-cols-[0.75fr_1.25fr] md:items-center">
                  <div><p className="font-mono text-[10px] uppercase tracking-[0.18em] text-red-400">{t("Timing ladder")}</p><p className="mt-3 text-lg font-medium text-white">{t("Short for feedback. Longer for spatial change.")}</p></div>
              ...
              <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
                <SignalPanel interactive={false} tone="quiet" className="p-6">
                  <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-red-400">{t("Motion grammar")}</p>
                ...
                <SignalPanel interactive={false} tone="quiet" className="p-6">
                  <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-red-400">{t("Lifecycle")}</p>
              ...
              <div className="grid min-w-0 gap-4 xl:grid-cols-[1.1fr_0.9fr]">
                <SignalPanel interactive={false} tone="quiet" className="min-w-0">
                  <div className="min-w-0 p-6">
                    <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-red-400">{t("Spatial handoff")}</p>
                ...
                <SignalPanel interactive={false} tone="quiet" className="min-w-0">
                  <div className="min-w-0 p-6">
                    <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-red-400">{t("Direct manipulation")}</p>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <SignalPanel interactive={false} tone="quiet" className="p-6"><p className="font-mono text-[10px] uppercase tracking-[0.18em] text-emerald-300">{t("Use motion when")}</p><ul className="mt-5 space-y-2 text-sm leading-6 text-neutral-300"><li>{t("It connects a trigger to a changed state.")}</li><li>{t("It shows where content came from or where it went.")}</li><li>{t("It explains progress, completion, or replacement.")}</li><li>{t("The static state still communicates the full result.")}</li></ul></SignalPanel>
              ...
              <SignalPanel interactive={false} tone="quiet" className="p-6">
                <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-red-400">{t("Reduced-motion contract")}</p>
            ...
            <DocSection id="product-design">
              ...
              <div className="grid gap-4 lg:grid-cols-[1.05fr_0.95fr]">
                <SignalPanel interactive={false} tone="quiet" className="p-6">
                  <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-red-400">{t("Decision architecture")}</p>
            ...
            <DocSection id="patterns">
              ...
              <div className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
                <SignalPanel interactive={false} tone="quiet" className="p-5 sm:p-6">
                  <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-red-400">{t("Layout / command header")}</p>
                ...
                <SignalPanel interactive={false} tone="quiet" className="p-5 sm:p-6">
                  <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-red-400">{t("Layout / inspector rail")}</p>
            ...
            <DocSection id="guidance">
              ...
              <div className="grid gap-4 lg:grid-cols-[0.95fr_1.05fr]">
                <SignalPanel interactive={false} tone="quiet" className="p-6">
                  <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-red-400">{t("Content hierarchy")}</p>
                ...
                <SignalPanel interactive={false} tone="quiet" className="p-6">
                  <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-red-400">{t("State and feedback")}</p>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <SignalPanel interactive={false} tone="quiet" className="p-6"><p className="font-mono text-[10px] uppercase tracking-[0.18em] text-emerald-300">{t("Do")}</p><ul className="mt-5 space-y-3 text-sm leading-6 text-neutral-300"><li>{t("Give the page one obvious data or identity anchor.")}</li><li>{t("Use a border or tonal shift before introducing a shadow.")}</li><li>{t("Let nearby controls share a toolbar; keep global actions outside it.")}</li><li>{t("Use the grid to align information, not to decorate empty space.")}</li></ul></SignalPanel>
...
function RuleCard({ index, title, body }: { index: string; title: string; body: string }) {
  const t = useContext(I18nContext);
  return <SignalPanel interactive={false} tone="quiet" className="p-6"><span className="font-mono text-[10px] tracking-[0.18em] text-red-400">{index}</span><h3 className="mt-5 text-base font-medium text-white">{t(title)}</h3><p className="mt-3 text-sm leading-6 text-neutral-400">{t(body)}</p></SignalPanel>;
}

function MotionRule({ duration, label, width }: { duration: string; label: string; width: string }) {
  const t = useContext(I18nContext);
  return <div className="grid grid-cols-[78px_minmax(0,1fr)] items-center gap-4 font-mono text-[10px] uppercase tracking-[0.13em]"><span className="text-neutral-500">{duration}</span><div><div className={`h-1 ${width} rounded-full bg-red-400/80 shadow-[0_0_12px_rgba(248,113,113,0.35)]`} /><p className="mt-2 normal-case tracking-normal text-neutral-400">{t(label)}</p></div></div>;
}

function MotionRecipe({ trigger, preset, duration, output }: { trigger: string; preset: string; duration: string; output: string }) {
  const t = useContext(I18nContext);
  return <div className="grid gap-2 py-4 sm:grid-cols-[0.8fr_0.45fr_0.45fr_1.4fr] sm:items-center"><span className="text-sm text-white">{t(trigger)}</span><SignalChip tone={preset === "spatial" ? "signal" : "quiet"}>{preset}</SignalChip><span className="font-mono text-[10px] uppercase tracking-[0.12em] text-neutral-500">{duration}</span><span className="text-xs leading-5 text-neutral-400">{t(output)}</span></div>;
}
...
function MotionGuideline({ index, title, body }: { index: string; title: string; body: string }) {
  const t = useContext(I18nContext);
  return <li className="rounded-xl border border-white/[0.07] bg-white/[0.02] p-4"><span className="font-mono text-[10px] tracking-[0.16em] text-red-400">{index}</span><p className="mt-3 font-medium text-white">{t(title)}</p><p className="mt-2 text-xs leading-5 text-neutral-400">{t(body)}</p></li>;
}
...
function HierarchyRow({ level, style, use }: { level: string; style: string; use: string }) {
  const t = useContext(I18nContext);
  return <div className="grid grid-cols-[78px_minmax(0,1fr)] gap-4"><span className="pt-0.5 font-mono text-[10px] uppercase tracking-[0.14em] text-red-400">{t(level)}</span><div><p className={style}>{t("Example signal")}</p><p className="mt-1 text-xs leading-5 text-neutral-500">{t(use)}</p></div></div>;
}
