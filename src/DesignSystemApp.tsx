            ...
            <DocSection id="guidance">
              ...
              <div className="grid gap-4 xl:grid-cols-2">
                <SignalPanel interactive={false} tone="command" className="min-w-0 p-6">
                  ...
                  <div className="mt-3 overflow-hidden rounded-xl border border-white/[0.07]"><CodeBlock label="TSX" code={`import { SignalPanel, SignalToolbar } from "@mikkoayaka/sparx-ui";`} /></div>
                </SignalPanel>
